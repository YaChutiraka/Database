<html>
	...
	<body>
		...
		<form action="http://localhost/codes/myonlinestore_2/orderAdded.php" method="post">
			<b>Create An Order/Cart</b>
			<p>Today's Date (YYYY-MM-DD):
				<input type="text" name="date" size="30" maxlength="10" value=""></>
			</p>
			<p>
