<html>
	...
	<body>
		...
		<h1> Account Menu </h1>
		<p> Create a new account <a href="http://localhost/codes/myonlinestore_2/addUser.php"> click</a></p>
		<p> Update an existing account <a href="http://localhost/codes/myonlinestore_2/updateUser.php"> click</a></p>
		<p> Delete an existing account <a href="http://localhost/codes/myonlinestore_2/deleteUser.php"> click</a></p>
	</body>
</html>