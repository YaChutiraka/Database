<html>
	...
	<body>
		...
		<h1> Product Menu </h1>
		<p> Create a new product <a href="http://localhost/codes/myonlinestore_2/addProduct.php"> click</a></p>
		<p> Update an existing product <a href="http://localhost/codes/myonlinestore_2/updateProduct.php"> click</a></p>
		<p> Delete an existing product <a href="http://localhost/codes/myonlinestore_2/deleteProduct.php"> click</a></p>
	</body>
</html>