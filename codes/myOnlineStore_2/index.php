<html>
	...
	<body>
		...
		<h1>WELCOME to Megan & Ya's Online Store!</h1>
		<form action="http://localhost/codes/myonlinestore_2/searchProduct.php" method="post">
			<h4>What are you looking for? <input type="text" name="searchKey" size="30" value=""></h4> 
