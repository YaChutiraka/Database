<html>
	...
	<body>
		...
		<form action="http://localhost/codes/myonlinestore_2/orderDateUpdated.php" method="post">
			<b>Update Date Of Order/Cart</b>
			<!-- <p><em>Required</em></p> -->
			<p>Date (YYYY-MM-DD):
				<input type="text" name="date" size="30" maxlength="100" value=""></>
			</p>
			<p>Order ID:
