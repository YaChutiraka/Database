<html>
	...
	<body>
		...
		<h1> Order Menu </h1>
		<p> Create a new order/cart <a href="http://localhost/codes/myonlinestore_2/addOrder.php"> click</a></p>
		<p> Update an existing order/cart <a href="http://localhost/codes/myonlinestore_2/updateOrderMenu.php"> click</a></p>
		<p> Delete an existing order/cart <a href="http://localhost/codes/myonlinestore_2/deleteOrder.php"> click</a></p>
	</body>
</html>