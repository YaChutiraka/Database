<html>
	...
	<body>
		...
		<form action="http://localhost/codes/myonlinestore_2/productUpdated.php" method="post">
			<b>Update Product Details</b>
			<p>Product ID (required):
				<input type="text" name="id" size="30" maxlength="8" value=""></>
			</p>
			<p>Name:
				<input type="text" name="name" size="30" maxlength="100" value=""></>
			</p>
			<p>Price($):
				<input type="text" name="price" size="30" maxlength="21" value=""></>
			</p>
			<p>Stock Quantity:
				<input type="text" name="stock_quantity" size="30" value=""></>
			</p>
			<p>Description:
				<input type="text" name="description" size="30" maxlength="300" value=""></>
			</p>
			<p>Active:
				<input type="text" name="active" size="30" maxlength="1" value=""></>
			</p>
			<p>
