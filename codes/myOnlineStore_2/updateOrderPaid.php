<html>
	...
	<body>
		...
		<form action="http://localhost/codes/myonlinestore_2/orderPaidUpdated.php" method="post">
			<b>Update Paid Status Of Order/Cart</b>
			<!-- <p><em>Required</em></p> -->
			<p>Paid:
				<input type="text" name="paid" size="30" maxlength="100" value=""></>
			</p>
			<p>Order ID:
