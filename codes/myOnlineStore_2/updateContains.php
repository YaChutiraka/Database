<html>
	...
	<body>
		...
		<form action="http://localhost/codes/myonlinestore_2/containsUpdated.php" method="post">
			<b>Update Quantity In Order/Cart</b>
			<!-- <p><em>Required</em></p> -->
			<p>Product ID:
				<input type="text" name="product_id" size="30" maxlength="100" value=""></>
			</p>
			<p>Quantity:
				<input type="text" name="quantity" size="30" maxlength="100" value=""></>
			</p>
